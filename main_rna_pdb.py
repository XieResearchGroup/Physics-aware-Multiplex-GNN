...
def main():
    ...
    parser.add_argument('--cutoff_l', type=float, default=0.08, help='cutoff in local layer')
    parser.add_argument('--cutoff_g', type=float, default=0.250, help='cutoff in global layer')
